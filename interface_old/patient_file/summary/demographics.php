  ...
  <tr>
      <td class="small" colspan='4'>
          ...
          |
           ...
           <?php $res = sqlStatement("SELECT * FROM form_vitals WHERE pid=".$pid);
            $vitalData=array();
            $book = new stdClass;
           while ($row = sqlFetchArray($res))
            { array_push($vitalData,$row);
             ...
             $GLOBALS['pp']="aniket";
            ?>
          <a href="../../reports/vital_report.php?obj=<?php print_r($vitalData)?>" onclick='top.restoreSession()'>
            
            <form method="post" action="../../reports/vital_report.php">
            <input type="hidden" name="obj" value="<?php print_r($vitalData)?>">
              <input type="submit">
               </form>
